...
HD_PWD='C:/Users/Cyphe/Documents/SUSTech Assignment/Term 3/Digital Logic/Lab Exercise/Week 12/project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Breath_light.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Breath_light.tcl
