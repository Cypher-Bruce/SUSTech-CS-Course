...
HD_PWD='C:/Users/Cyphe/Documents/SUSTech Assignment/Term 3/Digital Logic/Lab Exercise/Week 12/project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Breath_light.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Breath_light.tcl -notrace
