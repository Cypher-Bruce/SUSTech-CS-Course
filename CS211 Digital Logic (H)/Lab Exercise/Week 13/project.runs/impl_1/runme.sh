...
HD_PWD='C:/Users/Cyphe/Documents/SUSTech Assignment/Term 3/Digital Logic/Lab Exercise/Week 13/project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log clk_test.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source clk_test.tcl -notrace
