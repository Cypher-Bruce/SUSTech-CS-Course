...
HD_PWD='C:/Users/Cyphe/Documents/SUSTech Assignment/Term 3/Digital Logic/Lab Exercise/Week 5/project/project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Practice2_B.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Practice2_B.tcl
