...
HD_PWD='C:/Users/Cyphe/Documents/SUSTech Assignment/Term 3/Digital Logic/Lab Exercise/Week 5/project/project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Practice2_B.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Practice2_B.tcl -notrace
