...
\lhead{\footnotesize Digital Logic(H): Theory Assignment 1 Answer}% \lhead puts text in the top left corner. \footnotesize sets our font to a smaller size.
...
\begin{center}
	{\Large \bf Theory Assignment 1 Answer}
	%\vspace{2mm}
